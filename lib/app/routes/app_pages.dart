...
import '../modules/review_select/review_select_binding.dart';
import '../modules/review_select/review_select_view.dart';
...
import '../modules/wrong_notebook/wrong_notebook_binding.dart';
import '../modules/wrong_notebook/wrong_notebook_view.dart';
...
abstract class AppPages {
  static final pages = <GetPage<dynamic>>[
    ...
    GetPage(
      name: AppRoutes.reviewSelect,
      page: () => const ReviewSelectView(),
      binding: ReviewSelectBinding(),
    ),
    GetPage(
    ...
    GetPage(
      name: AppRoutes.coopLearn,
      page: () => const CoopLearnView(),
      binding: CoopLearnBinding(),
    ),
    GetPage(
      name: AppRoutes.coopCoach,
      page: () => const CoopCoachView(),
      binding: CoopCoachBinding(),
    ),
    GetPage(
