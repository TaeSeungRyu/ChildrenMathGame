...
> 현재 상태: 마켓 배포 진행(버전 `2.2.1+18`). 게임 탭 미니게임 7종 모두 플레이 가능(몬스터 처치 / 풍선 터뜨리기 / 타워 디펜스 / 두더지 잡기 / 숫자 사다리 / 물고기 잡기 / 저울 맞추기). 최근 반영: BGM/효과음 채널 분리, 미니게임 최고기록 저장, 부모 주간 리포트, 아바타+다중 프로필, **부모와 함께하는 학습(Nearby Connections 실시간 협동)**.
